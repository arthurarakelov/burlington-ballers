      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-8">
        <div className="max-w-md w-full">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xs font-light text-gray-600 mt-4">Sign in with Google to join games and track your RSVPs</p>
          </div>
            ...
            >
              {loading ? (
                ...
                <>
                  ...
                  <span className="group-hover:tracking-[0.4em] transition-all duration-500">SIGN IN WITH GOOGLE</span>
                </>
              )}
            </button>
          </div>
